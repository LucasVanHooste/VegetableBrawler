...
public class AnimationsController {
    ...
    public void Update()
    {
        if (!_physicsController.enabled) return;
    ...
    {
        _animator.SetBool(_attackParameter, attack);
    }

    public void SpecialAttack(bool specialAttack)
    {
        _animator.SetBool(_specialAttackParameter, specialAttack);
    }
